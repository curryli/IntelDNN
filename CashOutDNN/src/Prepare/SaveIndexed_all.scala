...
object SaveIndexed_all {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var labeledData1 = IntelUtil.get_from_HDFS.get_labeled_DF(ss, "xrli/IntelDNN/CashOut/201607_new/Labeled_All" )//.persist(StorageLevel.MEMORY_AND_DISK_SER)// .cache         //.persist(StorageLevel.MEMORY_AND_DISK_SER)//
    //var labeledData2 = IntelUtil.get_from_HDFS.get_labeled_DF(ss, "xrli/IntelDNN/CashOut/201608/Labeled_All" )//.persist(StorageLevel.MEMORY_AND_DISK_SER)// .cache         //.persist(StorageLevel.MEMORY_AND_DISK_SER)//
    //var labeledData3 = IntelUtil.get_from_HDFS.get_labeled_DF(ss, "xrli/IntelDNN/CashOut/201609/Labeled_All" )
...
//////////////////////////////
    ...
    labeledData.selectExpr(labeled_arr:_*).rdd.map(_.mkString(",")).saveAsTextFile("xrli/IntelDNN/CashOut/models/idx_withlabel_07_newRatio")
