  ...
  def main(args: Array[String]): Unit = {
   ...
   val startTime = System.currentTimeMillis(); 
    ...
    var FraudData = hc.sql(s"select t1.tfr_dt_tm, t1.trans_at, t1.total_disc_at, "+
      ...
      s"where t1.pdate>=20160702 and t1.pdate<=20160702 ").repartition(1000).persist(StorageLevel.MEMORY_AND_DISK_SER)  //.cache 
    ...
    result.rdd.saveAsTextFile("xrli/IntelDNN/20160702_Labeled")
