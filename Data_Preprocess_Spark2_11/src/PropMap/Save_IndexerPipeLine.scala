...
object Save_IndexerPipeLine {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val enddate = "20160705"
    var AllData = IntelUtil.get_from_HDFS.get_filled_DF(ss, startdate, enddate).repartition(15000).persist(StorageLevel.MEMORY_AND_DISK_SER)// .cache         //.persist(StorageLevel.MEMORY_AND_DISK_SER)//
    AllData.show(5)
