...
object save_Alldata_bycards {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val counterfeit_cards= sc.textFile("xrli/IntelDNN/counterfeit_cards_0708.csv") 
    
    val sample_cards= sc.textFile("xrli/IntelDNN/All_sample_cards_1607") 
      
    var all_cards = sample_cards.union(counterfeit_cards)
    ...
    Alldata_by_cards.rdd.map(_.mkString(",")).saveAsTextFile("xrli/IntelDNN/Counterfeit/Alldata_by_cards")
