  ...
  def main(args: Array[String]): Unit = {
    ...
    val label_indexer = new StringIndexer()
     ...
     .fit(vec_data)  
      ...
      val predictionResultDF_07 = model.transform(test_07_indexed)
...
//     val rfClassifier2 = new RandomForestClassifier()
//        .setLabelCol("label_idx")
//        .setFeaturesCol("featureVector")
//        .setNumTrees(15)
//        .setMaxBins(10000)  
//      
//      val pipeline2 = new Pipeline().setStages(Array(assembler,label_indexer, rfClassifier2))
//      
//      val model2 = pipeline2.fit(vec_data)
//       
//      val predicts_2 = model2.transform(test_07_indexed)
//        
//      val eval_result_2 = IntelUtil.funUtil.get_CF_Matrix(predicts_2)
//       
//     println("Current Precision_P_2 is: " + eval_result_2.Precision_P)
//     println("Current Recall_P_2 is: " + eval_result_2.Recall_P)
