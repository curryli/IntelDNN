...
object RF_OneHot {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var data_FE = FE_OneHot.FE_function(hc).repartition(1000).persist(StorageLevel.MEMORY_AND_DISK_SER)
    ...
    println("temp done")
     ...
     //////////////////////////////////////////////////////
    val CatVecArr = IntelUtil.varUtil.DisperseArr.map { x => x + "_onehot"}
