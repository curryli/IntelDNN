...
object SaveIndexed_all {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var labeledData1 = IntelUtil.get_from_HDFS.get_labeled_DF(ss, "xrli/IntelDNN/CashOut/201607/Labeled_All" )//.persist(StorageLevel.MEMORY_AND_DISK_SER)// .cache         //.persist(StorageLevel.MEMORY_AND_DISK_SER)//
