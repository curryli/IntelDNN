...
object count_label {
  ...
  def main(args: Array[String]): Unit = {
   ...
   labeledData = labeledData.withColumn("is_HR_Term_2", is_HR_Term_2(labeledData("term_cd_filled_idx")))
    ...
    val more_trans_st = udf[Double, Double]{xstr => any_to_double(xstr.toDouble>7)}    
    ...
    val more_Tcc = udf[Double, Double]{xstr => any_to_double(!HR_Tccs.contains(xstr.toInt))}    
    ...
    val more_Rc = udf[Double, Double]{xstr => any_to_double(!HR_Rcs.contains(xstr.toInt))}    
   ...
   println("more_RScc")
    ...
    val more_RScc = udf[Double, Double]{xstr => any_to_double(!HR_RSccs.contains(xstr.toInt))}    
    ...
    val more_RSCR = udf[Double, Double]{xstr => any_to_double(!HR_RSCRs.contains(xstr.toInt))}    
    labeledData = labeledData.withColumn("more_RSCR", more_RSCR(labeledData("rcv_settle_conv_rt_filled_idx")))
    
    
     println("more_pemc")
    val more_pemc = udf[Double, Double]{xstr => any_to_double(xstr.toDouble>20)}    
    ...
    val more_Pcc = udf[Double, Double]{xstr => any_to_double(!HR_Pccs.contains(xstr.toInt))}    
    labeledData = labeledData.withColumn("more_Pcc", more_Pcc(labeledData("pos_cond_cd_filled_idx")))
    
     println("more_OTS")
    val more_OTS = udf[Double, Double]{xstr => any_to_double(xstr.toDouble>10)}    
    ...
    var label_arr = Array("is_HR_AIRC", "is_HR_MC", "is_HR_Term", "is_HR_CA_2", "is_HR_AIRC_2", "is_HR_MC_2", "is_HR_Term_2", "more_trans_st", "more_tcc", "more_Rc", "more_RScc", "more_RSCR", "more_pemc", "more_Pcc", "more_OTS", "is_HR_mcc", "is_HR_IIC", "is_HR_FSC", "is_HR_FSCR", "is_HR_CCC", "is_HR_CCR", "is_HR_card_media", "is_HR_CAC")
    ...
    countdf .show(20)
    var savepath = "xrli/credit/count_label.csv"
